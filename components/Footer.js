...
import { FaFacebook, FaTwitter, FaInstagram, FaLinkedin,FaGithub,FaGooglePlus } from 'react-icons/fa';
import Link from 'next/link';

const Footer = () => {
  return (
   
//  <footer class="static bg-neutral-100 mt-40 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
...
//            <Image src='/logo.svg' width={24} height={24} className="m-3"/>
//           Icecube 
//         </h6>
//         <p>
    ...
    <div className="container mx-auto flex flex-col md:flex-row justify-center  items-center">
      <div className="mb-4 md:mb-0">
        <div className="flex space-x-2">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <FaGooglePlus className="w-6 h-6 hover:text-gray-300"/>
          </a>
        </div>
      </div>
    </div>
