...
const Navbar = () => {
  ...
  return (
    ...
    // <nav className="sticky top-0 z-50  flex items-center bg-orange/80 text-dark justify-between flex-wrap p-4 border-b-2 border-gray-200 border-opacity-0 transition-opacity duration-300">
      ...
      <nav className={`flex items-center bg-white/90 text-dark justify-between flex-wrap p-4 border-b-2 border-gray-200 border-opacity-0 transition-opacity duration-300 ${shouldStick ? 'sticky top-0 z-50' : ''}`}>
